...
- [ ] **Fix:** Check Ai Service Time Res Slow Debug Step {1.Ai Service -> 2.User Service -> 3.Line Hook -> 4.Network}
...
- [ ] **Fix:** Close ports and the public IP Close Inbound(server/vultr) — **Deadline:** 29.08.26
