...
const resources = {
    th: {
        translation: {
            ...
            errors: {
                http: {
                    badRequest: "ข้อมูลไม่ถูกต้อง กรุณาตรวจสอบอีกครั้ง",
                    unauthorized: "เซสชันหมดอายุ กรุณาเข้าสู่ระบบใหม่",
                    forbidden: "คุณไม่มีสิทธิ์ทำรายการนี้",
                    notFound: "ไม่พบข้อมูลที่ต้องการ",
                    conflict: "ข้อมูลนี้มีอยู่แล้ว",
                    validation: "ข้อมูลไม่ถูกต้อง กรุณาตรวจสอบอีกครั้ง",
                    tooManyRequests: "ส่งคำขอมากเกินไป กรุณาลองใหม่ภายหลัง",
                    timeout: "การเชื่อมต่อล่าช้า กรุณาลองใหม่อีกครั้ง",
                    network: "ไม่สามารถเชื่อมต่อเครือข่ายได้ กรุณาตรวจสอบอินเทอร์เน็ต",
                    server: "เกิดข้อผิดพลาดของเซิร์ฟเวอร์ กรุณาลองใหม่อีกครั้ง",
