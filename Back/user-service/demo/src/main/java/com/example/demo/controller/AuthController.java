...
import com.example.demo.dto.req.LineLiffTokenReq;
...
public class AuthController {
    ...
    @PostMapping("/line/liff")
    public ResponseEntity<ApiRes<AuthRes>> lineLiffLogin(@RequestBody LineLiffTokenReq req) {
        AuthRes data = lineAuthService.loginWithLiff(req.idToken(), req.accessToken());
        return ResponseEntity.ok(ApiRes.success(data, "Login Success"));
    }
}
