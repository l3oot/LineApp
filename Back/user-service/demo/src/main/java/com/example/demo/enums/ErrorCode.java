...
public enum ErrorCode {
    ...
    AGRI_PRICE_API_ERROR(TypeError.INTERNAL_ERROR, HttpStatus.BAD_GATEWAY),
    ...
    CYCLE_QUOTA_EXCEEDED(TypeError.CONFLICT, HttpStatus.CONFLICT),
    CYCLE_NOTE_TOO_LONG(TypeError.VALIDATION_ERROR, HttpStatus.BAD_REQUEST),
