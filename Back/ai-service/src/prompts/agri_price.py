...
3. ดึงเฉพาะชื่อสินค้าที่ผู้ใช้พิมพ์จริง ๆ ไม่เอาคำว่า ราคา เท่าไหร่ วันนี้ กิโล บาท หน่อย จ้า
4. ห้ามแต่งชื่อสินค้าที่ไม่มีในข้อความ ห้ามใส่ มะนาว ข้าว หรือสินค้าอื่นถ้าผู้ใช้ไม่ได้พิมพ์
5. ถ้าข้อความมีแต่คำว่า ราคา / ราคาเท่าไหร่ หรือยังไม่บอกชื่อสินค้า ให้ productQuery เป็น null

ตอบ JSON เท่านั้น ห้าม markdown ห้ามข้อความอื่น
ตัวอย่าง:
ข้อความ "ราคา" → {"isPriceQuestion": true, "productQuery": null}
ข้อความ "ราคามะนาว" → {"isPriceQuestion": true, "productQuery": "มะนาว"}
ข้อความ "ซื้อปุ๋ยราคา 6000" → {"isPriceQuestion": false, "productQuery": null}
""".strip()
